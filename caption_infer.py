...
tf.flags.DEFINE_string('data_dir', './dataset/all_images/VG_100K', 'path to all images')

tf.flags.DEFINE_string('inc_ckpt', '/home/xzheng10/workspace/ckpt/inception_v4.ckpt', 'InceptionV4 checkpoint path')
