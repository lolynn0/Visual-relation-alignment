...
tf.flags.DEFINE_string('job_dir', '/home/xzheng10/workspace/unsupervised_captioning/saving_baseline', 'job dir')
...
tf.flags.DEFINE_string('imcap_ckpt', '/home/xzheng10/workspace/unsupervised_captioning/saving_imcap/model.ckpt-18000', 'initialization checkpoint')

tf.flags.DEFINE_string('sae_ckpt', '/home/xzheng10/workspace/unsupervised_captioning/sen_gan/model.ckpt-30000', 'initialization checkpoint')
...
def rl_loss(gan_model, gan_loss, classes, num, add_summaries):
  ...
  o_rewards = obj_rewards(sequence, mask, classes, num) * FLAGS.w_obj
  ...
  baselines += obj_rewards(seq_bl, mask, classes, num) * FLAGS.w_obj
